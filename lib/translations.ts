...
export const translations = {
  en: {
    ...
    review_8_text: "Very professional team. They answered all my questions about YouTube watch hours and helped me get monetized.",
  ...
  ku: {
    ...
    review_8_text: "تیمێکی زۆر پڕۆفیشناڵن. وەڵامی هەموو پرسیارەکانیان دایەوە دەربارەی کاتژمێرەکانی یوتوب.",
