// ============================================================
// ARMAND STORE — Translations
// EN + Kurdish Sorani (ku)
// Brand names (Windows, Gemini, YouTube, TikTok, Telegram,
// Instagram, Facebook) remain in their original form.
// ============================================================
...
export const translations = {
  en: {
    ...
    // Products section
    products_heading: "OUR SERVICES",
    products_subheading: "Simple prices. Fast service. Easy ordering.",

    // Product: Windows
    win_name: "Windows 10 / 11",
    win_desc: "Home / Pro Activation Key",
    win_price: "5,000 IQD",

    // Product: Gemini
    gemini_name: "Gemini Pro",
    gemini_duration: "18 Months",
    gemini_price: "10,000 IQD",

    // Product: YouTube
    yt_name: "YouTube Services",
    yt_subtitle: "YouTube Monetization Support",
    yt_tier1_label: "1,000 Subscribers",
    yt_tier1_price: "20,000 IQD",
    yt_tier2_label: "4,000 Valid Public Watch Hours",
    yt_tier2_price: "20,000 IQD",
    yt_tier3_label: "1,000 Subscribers + 4,000 Watch Hours",
    yt_tier3_price: "35,000 IQD",
    yt_best_offer: "BEST OFFER",
    yt_disclaimer:
    ...
    tt_tier1_price: "8,000 IQD",
    tt_tier2_label: "5,000 Followers",
    tt_tier2_price: "29,000 IQD",
    tt_tier3_label: "10,000 Followers",
    tt_tier3_price: "57,000 IQD",

    // Product: Telegram
    tg_name: "Telegram Members",
    tg_tier1_label: "1,000 Members",
    tg_tier1_price: "3,000 IQD",
    tg_tier2_label: "5,000 Members",
    tg_tier2_price: "5,000 IQD",
    tg_tier3_label: "10,000 Members",
    tg_tier3_price: "8,000 IQD",
    ...
    review_3_role: "Gamer",
    review_4_text: "The TikTok followers were delivered instantly and really helped boost my account's credibility. Amazing service!",
    review_4_role: "Influencer",
    review_5_text: "Purchased a Windows 11 key and it worked flawlessly. I'm very satisfied with the quick delivery and support.",
    review_5_role: "Software Engineer",
    review_6_text: "Telegram members joined my channel within an hour. High quality profiles and very stable. Will buy again.",
    review_6_role: "Channel Owner",
    review_7_text: "I was skeptical at first, but Armand Store delivered perfectly. The Gemini Advanced is exactly what I needed.",
    review_7_role: "Student",
    review_8_text: "Very professional team. They answered all my questions about YouTube subscribers and helped me grow my channel.",
    review_8_role: "Vlogger",
    review_9_text: "FIB payment was seamless. I received my order in less than 5 minutes. The best digital store in the region.",
    review_9_role: "Freelancer",
    review_10_text: "Great quality for TikTok likes and views. My video reached the FYP thanks to their fast service!",
    review_10_role: "Creator",
    // Social
  ...
  ku: {
    ...
    // Products section
    products_heading: "خزمەتگوزارییەکانمان",
    products_subheading: "نرخی سادە. خزمەتگوزاری خێرا. داواکاریی ئاسان.",

    // Product: Windows
    win_name: "Windows 10 / 11",
    win_desc: "کۆدی چالاککردنی Home / Pro",
    win_price: "5,000 دینار",

    // Product: Gemini
    gemini_name: "Gemini Pro",
    gemini_duration: "١٨ مانگ",
    gemini_price: "10,000 دینار",

    // Product: YouTube
    yt_name: "خزمەتگوزارییەکانی YouTube",
    yt_subtitle: "پشتگیری داراییکردنی YouTube",
    yt_tier1_label: "١,٠٠٠ فۆلۆوەر",
    yt_tier1_price: "20,000 دینار",
    yt_tier2_label: "٤,٠٠٠ کاتژمێری تەماشاکردنی گشتی دروست",
    yt_tier2_price: "20,000 دینار",
    yt_tier3_label: "١,٠٠٠ فۆلۆوەر + ٤,٠٠٠ کاتژمێری تەماشاکردن",
    yt_tier3_price: "35,000 دینار",
    ...
    tt_tier1_label: "١,٠٠٠ فۆلۆوەر",
    tt_tier1_price: "8,000 دینار",
    tt_tier2_label: "٥,٠٠٠ فۆلۆوەر",
    tt_tier2_price: "29,000 دینار",
    tt_tier3_label: "١٠,٠٠٠ فۆلۆوەر",
    tt_tier3_price: "57,000 دینار",

    // Product: Telegram
    tg_name: "ئەندامانی Telegram",
    tg_tier1_label: "١,٠٠٠ ئەندام",
    tg_tier1_price: "3,000 دینار",
    tg_tier2_label: "٥,٠٠٠ ئەندام",
    tg_tier2_price: "5,000 دینار",
    tg_tier3_label: "١٠,٠٠٠ ئەندام",
    tg_tier3_price: "8,000 دینار",
    ...
    how_step1_title: "خزمەتگوزارییەکەت هەڵبژێرە",
    how_step2_title: "پەیوەندیمان پێوەبکە",
    ...
    review_4_text: "فۆڵۆوەرەکانی تیکتۆک زۆر خێرا گەیشتن و زۆر یارمەتیدەر بوون بۆ بەهێزکردنی ئەکاونتەکەم. خزمەتگوزارییەکی سەرسوڕهێنەر!",
    review_4_role: "ئینفلۆئەنسەر",
    review_5_text: "کلیلێکی Windows 11 م کڕی و بێ کێشە کاری کرد. زۆر ڕازیم لە خێرایی گەیاندن و پشتگیرییەکەیان.",
    review_5_role: "ئەندازیاری نەرمەکاڵا",
    review_6_text: "مێمبەرەکانی تێلیگرام لە ماوەی کاتژمێرێکدا هاتنە ناو کەناڵەکەمەوە. زۆر جێگیر و باش بوون.",
    review_6_role: "خاوەن کەناڵ",
    review_7_text: "لە سەرەتادا دوودڵ بووم، بەڵام Armand Store زۆر باش بوون. Gemini Advanced ڕێک ئەوە بوو کە پێویستم بوو.",
    review_7_role: "قوتابی",
    review_8_text: "تیمێکی زۆر پڕۆفیشناڵن. وەڵامی هەموو پرسیارەکانیان دایەوە دەربارەی سەبسکرایبەرەکانی یوتوب و یارمەتیان دام.",
    review_8_role: "ڤلۆگەر",
    review_9_text: "پارەدان بە FIB زۆر ئاسان بوو. داواکارییەکەم لە کەمتر لە ٥ خولەکدا پێگەیشت.",
    review_9_role: "فریلانەسەر",
    review_10_text: "کوالێتی زۆر باش بۆ لایک و ڤیووی تیکتۆک. ڤیدیۆکەم گەیشتە FYP بەهۆی خزمەتگوزارییە خێراکەیانەوە!",
    review_10_role: "دروستکەر",
    // Social
