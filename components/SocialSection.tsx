...
const SOCIAL_ITEMS = [
  {
    ...
    label: "Telegram",
    ariaLabel: "Join Armand Store on Telegram",
    icon: (
    ...
    style: "bg-sky-500/10 border-sky-500/20 text-sky-400 hover:bg-sky-500/20 hover:border-sky-500/40",
  },
  {
    ...
    style: "bg-pink-500/10 border-pink-500/20 text-pink-400 hover:bg-pink-500/20 hover:border-pink-500/40",
  },
  {
    key: "tiktok" as const,
    label: "TikTok",
    ...
    style: "bg-white/5 border-white/10 text-slate-300 hover:bg-white/10 hover:border-white/20",
  },
  {
    ...
    style: "bg-blue-600/10 border-blue-600/20 text-blue-400 hover:bg-blue-600/20 hover:border-blue-600/40",
  },
];
...
export default function SocialSection() {
  ...
  return (
    <section
      className="relative z-10 pt-24 pb-8 sm:pt-32 sm:pb-10"
